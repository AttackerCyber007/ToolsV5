...
echo
echo $pur"==================="$cy" ==================="
echo $i""$pu"  AUTHOR  :  5H311_1NJ3C706  "$i"                   "
echo $i""$pu"  WhatsApp:  08994422616"$i"                "
echo $i""$pu"  GMAIL   :  HackerBaloch07@gmail.com"$i"    "
echo $i""$pu"  TEAM :  BLACK PHANTOM CYBER"$i"                "
echo $pur"==================="$cy" ==================="
echo
...
sleep 2
echo $ku"Whatsapp :"$i" 08994422616"
echo $ku"YouTube  :"$i" YouTube BLACKHAT"
echo $ku"Facebook :"$i" Kevin Saputra"
sleep 2
echo $pur"Terima kasih Yang Sudah Support dengan Tools ini"
sleep 2
echo $pur"SEMOGA BERMANFAAT }"
exit
fi
